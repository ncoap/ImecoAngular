...
class Conexion {
   ...
   /*public function getConexion() {
    ...
    public function getConexion() {
       $pdo = new PDO("mysql:host=localhost;dbname=preve88h_odisea", "preve88h_victor", "F1l3serve", array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES  \"UTF8\"", PDO::ATTR_EMULATE_PREPARES => false));
       $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        return $pdo;
    }
}
