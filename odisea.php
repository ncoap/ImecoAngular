            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#intervencion"><i class="fa fa-save"></i><span>Registrar Intervención</span></a>
                        </li>
                    </ul>
                </li>
                <li class="treeview">
...
<script src="odisea.js"></script>
<script src="resources/assets/angular/checklist-model.js"></script>
<script src="odisea/home/home.js"></script>
<script src="odisea/operatividad/operatividad.js"></script>
<script src="odisea/intervencion/listar/listar_intervencion.js"></script>
<script src="odisea/intervencion/registrar/registrar_intervencion.js"></script>
<script src="odisea/intervencion/actualizar/actualizar_intervencion.js"></script>
<script src="odisea/intervencion/consolidado/consolidado.js"></script>
<script src="odisea/intervencion/reporte/ejecutivo.js"></script>
<script src="odisea/sensomatizado/listar/listar_sensomatizado.js"></script>
<script src="odisea/sensomatizado/registrar/registrar_sensomatizado.js"></script>
<script src="odisea/sensomatizado/actualizar/actualizar_sensomatizado.js"></script>
<script src="odisea/incidente/listar/listar_incidente.js"></script>
<script src="odisea/incidente/registrar/registrar_incidente.js"></script>
<script src="odisea/incidente/actualizar/actualizar_incidente.js"></script>
